...
jQuery(document).ready(function( $ ){
	...
	var pagebuilder = function(){
		...
		s.MEDIAmedia_library = function() {
		   var formfield = null;
	  
		   var wireframe;
	  
		   $('body').on('click', 'a.action-insert-image ',function(e) {
			   var from_part = $(this).parents('.form-part-insert-image').first();
			   e.preventDefault();
			   if (wireframe) {
				   wireframe.open();
				   return;
			   ...
			   wireframe.on('select', function() {
				   ...
				   console.log(attachment);
					from_part.find( '.form-part-insert-image-id' ).val( attachment.id );
			   });
